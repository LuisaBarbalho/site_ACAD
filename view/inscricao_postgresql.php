...
<body>
  ...
  <div class="form">
    <div class="container-fluid">
      <div id="inscricao-postgresql" class="categoria-banner">
        <img class="imagem-inscricao" src="../img/postgresql_logo.png"/>
      ...
      <form action="../controller/controller_postgresql.php" method="POST">
