...
<body>
  ...
  <div class="form">
    <div class="container-fluid">
      <div id="inscricao-linux" class="categoria-banner">
        <img class="imagem-inscricao" src="../img/linux_logo.png"/>
      ...
      <form action="../controller/controller_linux.php" method="POST">
